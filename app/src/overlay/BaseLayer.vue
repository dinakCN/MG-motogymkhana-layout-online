...
const props = defineProps({
  ...
  // Логотипы рисуют под светлый фон — эмблема клуба или федерации сплошь
  // и рядом почти чёрная и на тёмной сцене тонет. Светлая подложка снимает
...
// достаётся 138 px по высоте, и вордмарк читается; в среднем это
