...
4. Прощёлкать пять сцен с пульта, сверить с превью в блоке «Что в кадре».
...
| Клавиша | Действие |
|---|---|
| `1`…`5` | Сцена: таблица, заезд, хайлайт, пауза, награждение |
...
```bash
npm test          # 55 тестов: парсер, состояние, опросчик, форматирование
npm run test:watch
```
