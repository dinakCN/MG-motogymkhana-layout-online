...
| `logoMark` | та же эмблема без надписи | пауза (92 px), награждение (60 px), жучок в углу заезда и таблицы (52 px) |
...
| Клавиша | Действие |
|---|---|
| `1`…`7` | Сцена: таблица, заезд, хайлайт, пауза, награждение, заставка, чистый кадр |
